...
app = Flask(__name__)
app.secret_key = 'vinay@4288' # IMPORTANT: Change this to a strong, random key in production!
...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:585008050721:Travelgo:c04362ba-2064-425f-a3fc-6e7f5d3a06c2'  # Replace with actual SNS topic ARN
